...
//                case "C", "c" -> showTime();
//                case "D", "d" -> reboot(hallA, hallB, hallC, histroy);
...
//        System.out.println("Created hall successfully witt " + (row * seat) + " seats in hall");
//    }
//
...
//                    System.out.println("invalid, you should be input row range 1-26 ...!");
//                if (Objects.equals(op, "seat"))
//                    System.out.println("invalid, you should be input seat range 1-30 ...!");
